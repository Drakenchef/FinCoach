...
(1, 'Повышенные расходы в следующей категории - %s',
...
(777, 'Только начал?',
 'Привет! Если ты только начинаешь пользоваться приложением или просто еще не привык фиксировать расходы, это абсолютно нормально! Ведение бюджета — это не скучная обязанность, а полезный инструмент для понимания своих финансов. Давай попробуем начать с малого — просто записывать все основные траты. Уже через пару недель ты начнешь замечать интересные закономерности!'
)
;
